...
const Review = () => {
  ...
  useEffect(() => {
    fetch(`https://still-dawn-32083.herokuapp.com/reviews`)
      .then((res) => res.json())
            ...
            <div className="col-md-6">
              <div className="text-center py-3">
                <h2 className="fw-bold">
                  What Our <span className="text-info">Client</span> Say
                </h2>
                <p>
            ...
            {reviews?.map((review) => (
              <div className="col-md-5" key={Math.random()}>
                <div className="p-3 mb-2 single-client border border-dark rounded-1">
                  <div className="">
                    <img className="img-fluid" src={review.image} alt="profile img" />
                  </div>
                  <p>{review.review}</p>
